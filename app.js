...
const defaultProducts = [
    { id: "p1", categoryId: "cat1", name: "Kali Linux Pro Kit", priceSYP: 450000, description: "نسخة مخصصة من كالي مع 200+ أداة + دورة فيديو", image: "https://images.unsplash.com/photo-1550751827-4bd374c3f58b?w=400", createdAt: Date.now(), stock: 999, isDigital: true, rating: 4.9, views: 1243 },
    { id: "p2", categoryId: "cat1", name: "Burp Suite Pro License", priceSYP: 1250000, description: "رخصة سنة كاملة لأقوى أداة فحص ثغرات الويب", image: "https://images.unsplash.com/photo-1563986768609-322da13575f3?w=400", createdAt: Date.now(), stock: 25, isDigital: true, rating: 5.0, views: 892 },
    { id: "p3", categoryId: "cat2", name: "حزمة OSINT Master", priceSYP: 320000, description: "50 أداة OSINT + قوائم dorks + سكربتات بايثون", image: "https://images.unsplash.com/photo-1563013544-824ae1b704d3?w=400", createdAt: Date.now(), stock: 999, isDigital: true, rating: 4.7, views: 756 },
    { id: "p4", categoryId: "cat3", name: "VPN Lifetime", priceSYP: 850000, description: "اشتراك مدى الحياة - 3 أجهزة - 15 دولة", image: "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=400", createdAt: Date.now(), stock: 100, isDigital: true, rating: 4.8, views: 2104 },
    { id: "p5", categoryId: "cat4", name: "دورة اختراق أخلاقي كاملة", priceSYP: 680000, description: "35 ساعة فيديو بالعربي - شهادة معتمدة", image: "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=400", createdAt: Date.now(), stock: 999, isDigital: true, rating: 4.9, views: 3421 },
    { id: "p6", categoryId: "cat5", name: "Flipper Zero + إكسسوارات", priceSYP: 2750000, description: "جهاز Flipper Zero أصلي + كفر + هوائي", image: "https://images.unsplash.com/photo-1597225244661-8cfb5ddb0f8e?w=400", createdAt: Date.now(), stock: 7, isDigital: false, rating: 5.0, views: 5432 }
];
            ...
            <div className={`cart-sidebar ${cartOpen ? 'open' : ''}`}>
                ...
                {cart.length > 0 && (
                    <div className="cart-footer">
                        ...
                        <a href={getCartWhatsAppLink()} target="_blank" rel="noopener noreferrer" className="whatsapp-checkout">
